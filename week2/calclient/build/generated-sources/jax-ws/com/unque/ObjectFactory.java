 ...
 * generated in the com.unque package. 
...
public class ObjectFactory {
    ...
    private final static QName _Getnum_QNAME = new QName("http://unque.com/", "getnum");
    private final static QName _Sub_QNAME = new QName("http://unque.com/", "sub");
    private final static QName _SubResponse_QNAME = new QName("http://unque.com/", "subResponse");
    private final static QName _Div_QNAME = new QName("http://unque.com/", "div");
    private final static QName _DivResponse_QNAME = new QName("http://unque.com/", "divResponse");
    private final static QName _Mul_QNAME = new QName("http://unque.com/", "mul");
    private final static QName _MulResponse_QNAME = new QName("http://unque.com/", "mulResponse");
    private final static QName _GetnumResponse_QNAME = new QName("http://unque.com/", "getnumResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.unque
     * 
     */
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link Getnum }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://unque.com/", name = "getnum")
    public JAXBElement<Getnum> createGetnum(Getnum value) {
        return new JAXBElement<Getnum>(_Getnum_QNAME, Getnum.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://unque.com/", name = "sub")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://unque.com/", name = "subResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://unque.com/", name = "div")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://unque.com/", name = "divResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://unque.com/", name = "mul")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://unque.com/", name = "mulResponse")
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GetnumResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://unque.com/", name = "getnumResponse")
    public JAXBElement<GetnumResponse> createGetnumResponse(GetnumResponse value) {
        return new JAXBElement<GetnumResponse>(_GetnumResponse_QNAME, GetnumResponse.class, null, value);
    }
