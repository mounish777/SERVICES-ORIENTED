 ...
 * 
 */
@WebServiceClient(name = "calculator", targetNamespace = "http://unque.com/", wsdlLocation = "http://localhost:8080/calculatorwebservice/calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATOR_QNAME = new QName("http://unque.com/", "calculator");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://unque.com/", "calculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://unque.com/", "calculatorPort"), Calculator.class, features);
    }
